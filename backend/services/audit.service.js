/**
 * ================================================
 * AUDIT SERVICE - Traçabilité des actions sensibles
 * ================================================
 * Persiste les actions administratives et mutantes dans SQLite.
 *
...
const { redactSensitive } = require('./logger.service');
