/**
 * ================================================
 * ANOMALY DETECTION SERVICE — Détection d'anomalies par z-score
 * ================================================
 * Analyse les métriques historiques pour détecter des variations
 * anormales par rapport à la moyenne glissante.
 */

const metricSnapshotsService = require('./metricSnapshots.service');
...
module.exports = { detectAnomalies, calculateStats, METRIC_KEYS };
