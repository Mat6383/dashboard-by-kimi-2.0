          ...
          >
            ...
            <div
              ...
              style={{
                ...
                padding: '1.25rem',
                borderRadius: '12px',
                border: `1px solid ${d1.completionRate >= 90 ? '#10B981' : d1.completionRate >= 80 ? '#F59E0B' : '#EF4444'}`,
                borderLeftWidth: '6px',
              }}
            >
              <div
              ...
              >
                ...
                />
                <span style={{ fontWeight: 600, fontSize: '1.4rem', color: 'var(--text-color)' }}>
                  Taux d&apos;Exécution
                </span>
              </div>
              ...
              >
                ...
                <span style={{ color: 'var(--text-muted)' }}>
                  {useBusiness ? 'tests exécutés (Cible: ≥ 90%)' : 'tests executed (Target: ≥ 90%)'}
                </span>
              </div>
              <AlertItem alert={getAlertForMetric('Completion Rate')} useBusiness={useBusiness} />
            </div>
            ...
            <div
              ...
              style={{
                ...
                padding: '1.25rem',
                borderRadius: '12px',
                border: `1px solid ${d1.passRate >= 95 ? '#10B981' : d1.passRate >= 90 ? '#F59E0B' : '#EF4444'}`,
                borderLeftWidth: '6px',
              }}
            >
              <div
              ...
              >
                ...
                <span style={{ color: 'var(--text-muted)' }}>
                  {useBusiness ? 'tests réussis (Cible: ≥ 95%)' : 'tests passed (Target: ≥ 95%)'}
                </span>
              </div>
              <div
                style={{ marginTop: '0.5rem', fontSize: '0.85rem', color: 'var(--text-muted)', fontStyle: 'italic' }}
              >
                {useBusiness
            ...
            <div
              ...
              style={{
                ...
                padding: '1.25rem',
                borderRadius: '12px',
                border: `1px solid ${d1.failureRate <= 5 ? '#10B981' : d1.failureRate <= 10 ? '#F59E0B' : '#EF4444'}`,
                borderLeftWidth: '6px',
              }}
            >
              <div
              ...
              >
                ...
                <span style={{ color: 'var(--text-muted)' }}>
                  {useBusiness ? 'tests échoués (Cible: ≤ 5%)' : 'tests failed (Target: ≤ 5%)'}
                </span>
              </div>
              <AlertItem alert={getAlertForMetric('Failure Rate')} useBusiness={useBusiness} />
            </div>
            ...
            <div
              ...
              style={{
                ...
                padding: '1.25rem',
                borderRadius: '12px',
                border: `1px solid ${d1.testEfficiency >= 95 ? '#10B981' : d1.testEfficiency >= 90 ? '#F59E0B' : '#EF4444'}`,
                borderLeftWidth: '6px',
              }}
            >
              <div
              ...
              >
                ...
                <span style={{ color: 'var(--text-muted)' }}>
                  {useBusiness ? 'Approcher les 100% (≥ 95%)' : 'Approach 100% (≥ 95%)'}
                </span>
              </div>
              <div
                style={{ marginTop: '0.5rem', fontSize: '0.85rem', color: 'var(--text-muted)', fontStyle: 'italic' }}
              ...
              <AlertItem alert={getAlertForMetric('Test Efficiency')} useBusiness={useBusiness} />
            </div>
          </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1rem' }}>
              {sortedRuns.slice(0, showAllRuns ? sortedRuns.length : sortedRuns.length <= 12 ? 12 : 8).map((run) => (
                <div
                  ...
                  onMouseEnter={
                    run.isExploratory ? (e) => (e.currentTarget.style.transform = 'scale(1.02)') : undefined
                  }
